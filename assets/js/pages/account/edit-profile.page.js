parasails.registerPage('edit-profile', {
  ...
  beforeMount: function() {
    ...
    this.formData.referralEmailAddress = this.me.referralEmailAddress;
    this.formData.walletAddress = this.me.walletAddress;
  ...
  methods: {
    ...
    handleParsingForm: function() {
      ...
      // Validate email:
      //if(!argins.walletAddress) {
        //this.formErrors.walletAddress = true;
      //}
