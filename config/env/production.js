...
module.exports = {
  ...
  models: {
     ...
     ***************************************************************************/
    migrate: 'safe',
    // TODO: To change migrate value from 'alter' to 'safe',
  ...
  sockets: {
     ...
     *                                                                          *
     ***************************************************************************/
    onlyAllowOrigins: ['https://www.dorcoin.io', 'https://dorcoin.io'],
    // onlyAllowOrigins: ['http://localhost', 'http://staging.localhost'],
  ...
  custom: {
    ...
    internalEmailAddress: 'no-reply@dorcoin.io',
