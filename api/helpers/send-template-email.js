...
//nodemailer.createTestAccount((err, account) => {
  ...
  let transporter = nodemailer.createTransport({
      ...
      auth: {
          user: sails.config.custom.fromEmailAddress, // generated ethereal user
          pass: sails.config.custom.fromEmailPassword // generated ethereal password
      }
  });

  // setup email data with unicode symbols
  let mailOptions = {
      from: sails.config.custom.fromName , // sender address
